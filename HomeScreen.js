...
import { View, Text, TouchableOpacity, StyleSheet, SafeAreaView, StatusBar, ScrollView, Platform, Image } from 'react-native';
...
const HomeScreen = ({ onNavigate }) => (
  <SafeAreaView style={styles.container}>
    ...
    <ScrollView contentContainerStyle={styles.scrollContent}>
      ...
      <TouchableOpacity style={styles.heroButton} onPress={() => onNavigate('createTemplate')}>
        <LinearGradient
        ...
        >
          ...
          <View style={styles.heroTextContainer}>
            ...
            <Text style={styles.heroButtonSubtext}>Comece a criar sua próxima avaliação</Text>
          </View>
        </LinearGradient>
      </TouchableOpacity>
      ...
      <View style={styles.actionsGrid}>
        <TouchableOpacity style={styles.actionCard} onPress={() => onNavigate('corrector')}>
        ...
        <TouchableOpacity style={styles.actionCard} onPress={() => onNavigate('reports')}>
          <View style={styles.actionIconContainer}>
