       ...
       <SafeAreaView style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.card}>
            ...
            <TouchableOpacity style={styles.secondaryButton} onPress={() => onNavigate('corrector')}>
        ...
        <View style={styles.card}>
          ...
          {Object.keys(correctAnswers).map((questionNumber) => (
            <View key={questionNumber} style={styles.answerRow}>
              <Text style={styles.questionNumber}>{questionNumber.padStart(2, '0')}.</Text>
...
const styles = StyleSheet.create({
  ...
  secondaryButton: {
    ...
    justifyContent: 'center', alignItems: 'center', marginTop: 10, // Diminuído marginTop para espaçamento padrão
